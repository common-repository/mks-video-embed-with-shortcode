...
mks_form_init_fields = function(){
	...
	jQuery(  '.otw-form-uploader' ).change( function(){
		mks_form_set_upload_preview_image( this.id );
	});
	jQuery(  '.otw-form-uploader-control' ).click( function( event ){
		...
		wp.media.editor.insert = function( params ){
			...
			mks_form_set_upload_preview_image( editor );
		}
		
		wp.media.editor.open( editor, options );
	} );
	jQuery(  '.otw-form-uploader-control' ).each( function(){
		mks_form_set_upload_preview_image( jQuery( this ).data( 'editor' ) );
	});
};
mks_form_set_upload_preview_image = function( element_id ){
