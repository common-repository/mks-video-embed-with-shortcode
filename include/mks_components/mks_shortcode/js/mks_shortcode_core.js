function mks_shortcode_tabs( selectors ){
...
function mks_shortcode_content_toggle( selector, closed ){
...
function mks_shortcode_accordions( accordions ){
...
function mks_shortcode_faq( faqs ){
...
function mks_shortcode_shadow_overlay( selectors ){
...
function mks_shortcode_testimonials( selectors ){
