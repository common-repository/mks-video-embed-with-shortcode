			...
			foreach( $messages as $message ){?>
				...
				<?php switch( $message_type ){
					...
					case 'error_message':?>
						...
						<?php break;
					default:?>
							<div class="mks_fc_lm_<?php echo $message_type ?> updated"><?php echo $message ?></div>
						<?php break;
				}
			}
		}
				...
				<div class="inside">
					...
					<?php
						...
						<form method="post" action="">
							...
							<input type="hidden" name="mks_fc_action" value="remove_pc_code" />
						...
						<form method="post" action="">
						<input type="hidden" name="mks_fc_action" value="add_pc_code" />
						...
						<p><input type="text" name="mks_pc_code" value="" id="mks_pc_code" /><input type="submit" name=mks_submit_pc_code" class="mks_factory_button_action button button-primary" value="<?php echo $this->get_label('Submit Code')?>"</p>
						</form>
					</div>
				</div>
			</div>
